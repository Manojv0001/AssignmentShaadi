...
import kotlinx.android.synthetic.main.row_declined_profiles.view.*

class DeclinedProfilesRecyclerAdapter(val context : Context?) : RecyclerView.Adapter<DeclinedProfilesRecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context)
            .inflate(R.layout.row_declined_profiles,parent,false)
